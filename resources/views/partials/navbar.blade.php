<nav class="navbar">
    <a href="#" class="nav-logo">huseinalhafiz</a>
    <div class="nav-links">
        <a href="{{ url('/#hero') }}">Beranda</a>
        <a href="{{ url('/#about') }}">Tentang Saya</a>
        <a href="{{ url('/#portfolio') }}">Portfolio</a>
        <a href="{{ url('/#education') }}">Pendidikan</a>
        <a href="{{ url('/#experience') }}">Pengalaman</a>
        <a href="{{ url('/#blog') }}">Blog</a>
        <a href="{{ url('/#contact') }}">Kontak</a>
        <button id="theme-toggle" style="background: none; border: none; cursor: pointer; color: var(--text-color); margin-left: 1rem; display: flex; align-items: center; justify-content: center;">
